 ...
 * @param val Valeur à utiliser pour certaines commandes internes (exemple : `exit` ou `for`).
...
/**
 * Vérifie si un délimiteur se trouve en dehors des accolades dans les arguments.
 *
 * @param args Tableau de chaînes de caractères contenant les arguments.
 * @param delimiter Délimiteur à rechercher (exemple : `|` ou `;`).
 ...
 * @param val Valeur passée à certaines commandes internes (exemple : `for` ou `exit`).
